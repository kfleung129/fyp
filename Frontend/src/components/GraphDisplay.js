...
export default function GraphDisplay(props) {
  const { displayContent, isLoading } = props;
  ...
  return (
    <div style={{ background: '#1d2029', width: '100vw', height: '90vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
